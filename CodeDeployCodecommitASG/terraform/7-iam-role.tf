...
resource "aws_iam_policy_attachment" "AWSCodeDeployRole-policy-attachment" {
    name       = "${local.default_name}-AWSCodeDeployRole-policy-attachment"
...
#------------------------------------------------------------------
resource "aws_iam_role" "AWSCodePipelineServiceRole-pipeline-codedeploy" {
    name               = "${local.default_name}-AWSCodePipelineServiceRole-pipeline-codedeploy"
    path               = "/service-role/"
    assume_role_policy = <<POLICY
{
  "Version": "2012-10-17",
...
#------------------------------------------------------------------
resource "aws_iam_policy_attachment" "AWSCodePipelineServiceRole-pipeline-codedeploy-policy-attachment" {
    name       = "${local.default_name}-AWSCodePipelineServiceRole-pipeline-codedeploy-policy-attachment"
    policy_arn = aws_iam_policy.AWSCodePipelineServiceRole-pipeline-codedeploy-policy.arn
    groups     = []
    users      = []
    roles      = [aws_iam_role.AWSCodePipelineServiceRole-pipeline-codedeploy.name]
    depends_on = [aws_iam_role.AWSCodePipelineServiceRole-pipeline-codedeploy]
}
#------------------------------------------------------------------
resource "aws_iam_policy" "AWSCodePipelineServiceRole-pipeline-codedeploy-policy" {
    name        = "${local.default_name}-AWSCodePipelineServiceRole-pipeline-codedeploy-policy"
    path        = "/service-role/"
