...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", default='django-insecure-m0i84t@nq*lf_!6t_y)wtgcicjrr3h^j(u1rst4ctyaxhr3ura')
print(".env.SECRET_KEY value is: {}".format(SECRET_KEY))
