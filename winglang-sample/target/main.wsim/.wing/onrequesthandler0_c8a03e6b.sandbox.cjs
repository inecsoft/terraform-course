...
exports.handler = async function(event) {
  $handler = $handler ?? (new (require("/home/iarteaga/.nvm/versions/node/v20.11.0/lib/node_modules/winglang/node_modules/@winglang/sdk/lib/target-sim/api.onrequest.inflight.js")).ApiOnRequestHandlerClient({ handler: 
          ...
          require("/home/iarteaga/terraform-course/winglang-sample/target/main.wsim/.wing/inflight.$Closure2-1.cjs")({
            $fn: (function() {
  let handle = process.env.FUNCTION_HANDLE_0b6dfeb0;
  if (!handle) {
    throw new Error("Missing environment variable: FUNCTION_HANDLE_0b6dfeb0");
  }
