...
// target/test/main.wsim/.wing/inflight.$Closure5-1.cjs
var require_inflight_Closure5_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure5-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $expect_Util, $http_Util, $std_Json, $url }) {
      class $Closure5 {
        static {
          __name(this, "$Closure5");
        }
        constructor({}) {
        ...
        async handle() {
          ...
          const r2 = await $http_Util.post($url, { body: ((json, opts) => {
          ...
          const r3 = await $http_Util.put(String.raw({ raw: ["", "/", ""] }, $url, id), { body: ((json, opts) => {
            return JSON.stringify(json, null, opts?.indent);
...
// target/test/main.wsim/.wing/handler_c89e709b.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    const $Closure5Client = require_inflight_Closure5_1()({
