...
var require_inflight_Closure3_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure3-1.cjs"(exports2, module2) {
    ...
    module2.exports = function({ $std_Json, $tasks }) {
      class $Closure3 {
        static {
        ...
        async handle(request) {
          ...
          })(request.vars, "id");
          {
            ...
            if ($if_let_value != void 0) {
              ...
              return { "status": 200, "headers": { ["Content-Type"]: "application/json" }, "body": ((json, opts) => {
...
// target/test/main.wsim/.wing/onrequesthandler2_c8d712d3.sandbox.cjs
var $handler = void 0;
