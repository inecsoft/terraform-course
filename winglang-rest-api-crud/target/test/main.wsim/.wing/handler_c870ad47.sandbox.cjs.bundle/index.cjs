...
// target/test/main.wsim/.wing/inflight.$Closure8-1.cjs
var require_inflight_Closure8_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure8-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $apiUrl, $invokeAndAssert }) {
      class $Closure8 {
        static {
          __name(this, "$Closure8");
        }
        constructor({}) {
...
// target/test/main.wsim/.wing/inflight.$Closure7-1.cjs
var require_inflight_Closure7_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure7-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $expect_Util, $http_Util }) {
      class $Closure7 {
        static {
          __name(this, "$Closure7");
        }
        constructor({}) {
          const $obj = /* @__PURE__ */ __name((...args) => this.handle(...args), "$obj");
          Object.setPrototypeOf($obj, this);
...
// target/test/main.wsim/.wing/handler_c870ad47.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    const $Closure8Client = require_inflight_Closure8_1()({
      $apiUrl: process.env["WING_TOKEN_WSIM_ROOT_ENV1_API_ATTRS_URL"],
      $invokeAndAssert: await (async () => {
        const $Closure7Client = require_inflight_Closure7_1()({
          $expect_Util: require_expect().Util,
          $http_Util: require_http().Util
        });
        const client2 = new $Closure7Client({});
