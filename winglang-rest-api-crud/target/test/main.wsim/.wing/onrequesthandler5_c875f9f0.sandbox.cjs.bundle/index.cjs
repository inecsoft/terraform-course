...
// target/test/main.wsim/.wing/inflight.$Closure9-1.cjs
var require_inflight_Closure9_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure9-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $counter, $std_Json, $tasks }) {
      class $Closure9 {
        static {
          __name(this, "$Closure9");
        }
        constructor({}) {
        ...
        async handle(request) {
          ...
          console.log(((json, opts) => {
            return JSON.stringify(json, null, opts?.indent);
          })(result));
          console.log($helpers.lookup(result, 0));
          return { "status": 200, "headers": { ["Content-Type"]: "text/html" }, "body": ((json, opts) => {
            return JSON.stringify(json, null, opts?.indent);
          })(result) };
        }
      }
...
// target/test/main.wsim/.wing/onrequesthandler5_c875f9f0.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure9Client = require_inflight_Closure9_1()({
          $counter: function() {
            let handle = process.env.COUNTER_HANDLE_45e060fd;
            if (!handle) {
              throw new Error("Missing environment variable: COUNTER_HANDLE_45e060fd");
            }
          ...
          $tasks: function() {
            let handle = process.env.TABLE_HANDLE_35c89193;
            if (!handle) {
              throw new Error("Missing environment variable: TABLE_HANDLE_35c89193");
            }
            const simulatorUrl = process.env.WING_SIMULATOR_URL;
            if (!simulatorUrl) {
              throw new Error("Missing environment variable: WING_SIMULATOR_URL");
