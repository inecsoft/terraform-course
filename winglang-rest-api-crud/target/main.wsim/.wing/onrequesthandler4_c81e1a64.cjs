...
exports.handler = async function(event) {
  ...
  handler: 
          ...
          require("/home/iarteaga/terraform-course/winglang-rest-api-crud/target/main.wsim/.wing/inflight.$Closure6-1.cjs")({
            $Utils: 
          require("/home/iarteaga/terraform-course/winglang-rest-api-crud/target/main.wsim/.wing/inflight.Utils-1.cjs")({
          })
        ,
            $counter: (function() {
