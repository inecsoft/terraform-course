...
export declare function storageBucketAutoclassToTerraform(struct?: StorageBucketAutoclassOutputReference | StorageBucketAutoclass): any;
export declare function storageBucketAutoclassToHclTerraform(struct?: StorageBucketAutoclassOutputReference | StorageBucketAutoclass): any;
export declare class StorageBucketAutoclassOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): StorageBucketAutoclass | undefined;
    set internalValue(value: StorageBucketAutoclass | undefined);
    private _enabled?;
    get enabled(): boolean | cdktf.IResolvable;
    set enabled(value: boolean | cdktf.IResolvable);
    get enabledInput(): boolean | cdktf.IResolvable | undefined;
    private _terminalStorageClass?;
    get terminalStorageClass(): string;
    set terminalStorageClass(value: string);
    resetTerminalStorageClass(): void;
    get terminalStorageClassInput(): string | undefined;
}
...
export declare function storageBucketCorsToHclTerraform(struct?: StorageBucketCors | cdktf.IResolvable): any;
...
export declare function storageBucketCustomPlacementConfigToTerraform(struct?: StorageBucketCustomPlacementConfigOutputReference | StorageBucketCustomPlacementConfig): any;
export declare function storageBucketCustomPlacementConfigToHclTerraform(struct?: StorageBucketCustomPlacementConfigOutputReference | StorageBucketCustomPlacementConfig): any;
export declare class StorageBucketCustomPlacementConfigOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string);
    get internalValue(): StorageBucketCustomPlacementConfig | undefined;
    set internalValue(value: StorageBucketCustomPlacementConfig | undefined);
...
export declare function storageBucketEncryptionToHclTerraform(struct?: StorageBucketEncryptionOutputReference | StorageBucketEncryption): any;
...
export declare function storageBucketLifecycleRuleActionToHclTerraform(struct?: StorageBucketLifecycleRuleActionOutputReference | StorageBucketLifecycleRuleAction): any;
...
export declare function storageBucketLifecycleRuleConditionToHclTerraform(struct?: StorageBucketLifecycleRuleConditionOutputReference | StorageBucketLifecycleRuleCondition): any;
export declare class StorageBucketLifecycleRuleConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    private _noAge?;
    get noAge(): boolean | cdktf.IResolvable;
    set noAge(value: boolean | cdktf.IResolvable);
    resetNoAge(): void;
    get noAgeInput(): boolean | cdktf.IResolvable | undefined;
...
export declare function storageBucketLifecycleRuleToHclTerraform(struct?: StorageBucketLifecycleRule | cdktf.IResolvable): any;
...
export declare function storageBucketLoggingToHclTerraform(struct?: StorageBucketLoggingOutputReference | StorageBucketLogging): any;
...
export declare function storageBucketRetentionPolicyToHclTerraform(struct?: StorageBucketRetentionPolicyOutputReference | StorageBucketRetentionPolicy): any;
...
export declare function storageBucketTimeoutsToTerraform(struct?: StorageBucketTimeouts | cdktf.IResolvable): any;
export declare function storageBucketTimeoutsToHclTerraform(struct?: StorageBucketTimeouts | cdktf.IResolvable): any;
...
export declare function storageBucketVersioningToHclTerraform(struct?: StorageBucketVersioningOutputReference | StorageBucketVersioning): any;
...
export declare function storageBucketWebsiteToHclTerraform(struct?: StorageBucketWebsiteOutputReference | StorageBucketWebsite): any;
...
export declare class StorageBucket extends cdktf.TerraformResource {
    ...
    * @param importFromId The id of the existing StorageBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.10.0/docs/resources/storage_bucket#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _enableObjectRetention?;
    get enableObjectRetention(): boolean | cdktf.IResolvable;
    set enableObjectRetention(value: boolean | cdktf.IResolvable);
    resetEnableObjectRetention(): void;
    get enableObjectRetentionInput(): boolean | cdktf.IResolvable | undefined;
    ...
    get url(): string;
    private _autoclass;
    get autoclass(): StorageBucketAutoclassOutputReference;
    putAutoclass(value: StorageBucketAutoclass): void;
    resetAutoclass(): void;
    get autoclassInput(): StorageBucketAutoclass | undefined;
    private _cors;
    ...
    get customPlacementConfig(): StorageBucketCustomPlacementConfigOutputReference;
    putCustomPlacementConfig(value: StorageBucketCustomPlacementConfig): void;
    resetCustomPlacementConfig(): void;
    get customPlacementConfigInput(): StorageBucketCustomPlacementConfig | undefined;
    private _encryption;
