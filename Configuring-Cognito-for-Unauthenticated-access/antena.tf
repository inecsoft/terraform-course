resource "aws_athena_workgroup" "athena_workgroup" {
  ...
  configuration {
    ...
    result_configuration {
      ...
      output_location = "s3://${aws_s3_bucket.s3_bucket_kinesis.bucket}/output/"
