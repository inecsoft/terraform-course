...
resource "aws_cloudfront_distribution" "s3_distribution" {
  depends_on = [ aws_s3_bucket.s3_bucket_web_kinesis ]

  origin {
      connection_attempts      = 3
      connection_timeout       = 10
      domain_name = aws_s3_bucket.s3_bucket_web_kinesis.bucket_regional_domain_name
      origin_id   = aws_s3_bucket.s3_bucket_web_kinesis.bucket_regional_domain_name
  ...
  default_cache_behavior {
    ...
    target_origin_id = aws_s3_bucket.s3_bucket_web_kinesis.bucket_regional_domain_name
...
resource "aws_cloudfront_origin_access_control" "cloudfront_origin_access_control" {
  name                              = aws_s3_bucket.s3_bucket_web_kinesis.bucket_regional_domain_name
