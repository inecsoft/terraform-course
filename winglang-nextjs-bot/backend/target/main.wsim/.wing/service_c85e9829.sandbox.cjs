      ...
      exports.start = async function() {
        ...
        const client = await 
          ...
          require("/home/iarteaga/terraform-course/winglang-nextjs-bot/backend/target/main.wsim/.wing/inflight.$Closure1-3.cjs")({
            ...
            $__parent_this_1_env: {"API_URL": process.env["WING_TOKEN_WSIM_ROOT_DEFAULT_API_ATTRS_URL"],"api_url": process.env["WING_TOKEN_WSIM_ROOT_DEFAULT_API_ATTRS_URL"],"TEXT": "Hello World!",},
  ...
  return require("@winglang/sdk/lib/simulator/client").makeSimulatorClient(simulatorUrl, handle, caller);
            ...
            $utils_Utils: 
      require("/home/iarteaga/terraform-course/winglang-nextjs-bot/backend/target/main.wsim/.wing/inflight.Utils-1.cjs")({
      })
    ,
          })
        ;
