...
export declare abstract class Resource extends Construct implements IResource {
     ...
     * other capabilities to the inflight host.
     */
    static onLiftType(host: IInflightHost, ops: string[]): void;
    /**
     ...
     */
    static toInflight(obj: IResource): string;
    /**
     ...
     * @internal
     */
    protected static _newFromFactory<TResource extends Resource>(fqn: string, scope: Construct, id: string, ...props: any[]): TResource;
    /**
     * Return a code snippet that can be used to reference this resource inflight.
     *
     * @internal
 ...
 * @noinflight
 */
export declare abstract class AutoIdResource extends Resource {
