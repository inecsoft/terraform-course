 ...
 */
export declare enum RequestCache {
    /**
 ...
 */
export declare enum RequestRedirect {
    /**
...
export declare class Util {
     ...
     */
    static fetch(url: string, options?: RequestOptions): Promise<Response>;
    /**
     ...
     */
    static parseUrl(urlString: string): Url;
    /**
     ...
     */
    static formatUrl(url: Url, options?: FormatUrlOptions): string;
    private static _formatResponse;
    private constructor();
}
