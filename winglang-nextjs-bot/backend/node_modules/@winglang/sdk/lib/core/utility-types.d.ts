 ...
 */
export type PickNonFunctions<T> = Pick<T, {
    [K in keyof T]: T[K] extends (...args: any[]) => any ? never : K;
}[keyof T]>;
/**
 * Represents a map of liftable objects with string keys.
 */
export type LiftableRecord = {
    [key: string]: Liftable;
};
/**
 ...
 */
export type Liftable = undefined | LiftablePrimitives | LiftableArray | ILiftable | IHostedLiftable | LiftableRecord | LiftableMap | LiftableSet;
/**
 * The lifted side of a liftable object.
 */
export type Lifted<T> = T extends {
    [INFLIGHT_SYMBOL]?: infer TClient;
} ? TClient : T extends Liftable ? T : never;
/**
