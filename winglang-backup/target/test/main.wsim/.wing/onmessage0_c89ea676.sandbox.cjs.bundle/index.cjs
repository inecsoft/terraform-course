...
var require_inflight_Closure2_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure2-1.cjs"(exports2, module2) {
    ...
    module2.exports = function({ $backup, $origin }) {
      class $Closure2 {
        static {
...
// target/test/main.wsim/.wing/onmessage0_c89ea676.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    const $func = /* @__PURE__ */ __name(async (ctx, event2) => {
      await ctx.handler(event2);
      return void 0;
    }, "$func");
    const $ctx = {
      handler: await (async () => {
        const $func2 = /* @__PURE__ */ __name(async (ctx, event2) => {
          return ctx.handler(event2, ctx.eventType);
        }, "$func");
        const $ctx2 = {
          handler: await (async () => {
