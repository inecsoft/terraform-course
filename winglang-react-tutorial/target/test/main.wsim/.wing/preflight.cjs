...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    class FlatFileSystem extends $stdlib.std.Resource {
      constructor($scope, $id, ) {
        super($scope, $id);
      }
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.FlatFileSystem-6.cjs")({
          })
        `;
      }
      _toInflight() {
        return `
          (await (async () => {
            const FlatFileSystemClient = ${FlatFileSystem._toInflightType()};
    ...
    class $Closure2 extends $stdlib.std.AutoIdResource {
      ...
      get _liftMap() {
        return ({
          "handle": [
            [fs, [].concat(["listFolders"], ["createFolder"])],
          ],
          "$inflight_init": [
            [fs, []],
          ],
    ...
    class $Closure3 extends $stdlib.std.AutoIdResource {
      ...
      get _liftMap() {
        return ({
          "handle": [
            [fs, [].concat(["createFolder"], ["createFile"], ["listFiles"], ["getFile"])],
          ],
          "$inflight_init": [
            [fs, []],
          ],
    ...
    const fs = new FlatFileSystem(this, "FlatFileSystem");
    this.node.root.new("@winglang/sdk.std.Test", std.Test, this, "test:get and create folders", new $Closure2(this, "$Closure2"));
    this.node.root.new("@winglang/sdk.std.Test", std.Test, this, "test:get and create file", new $Closure3(this, "$Closure3"));
  }
}
