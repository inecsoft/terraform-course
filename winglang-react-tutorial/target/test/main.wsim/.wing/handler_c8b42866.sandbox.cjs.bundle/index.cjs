...
// target/test/main.wsim/.wing/inflight.$Closure2-6.cjs
var require_inflight_Closure2_6 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure2-6.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $expect_Util, $fs }) {
      class $Closure2 {
        static {
...
// target/test/main.wsim/.wing/inflight.FlatFileSystem-6.cjs
var require_inflight_FlatFileSystem_6 = __commonJS({
  "target/test/main.wsim/.wing/inflight.FlatFileSystem-6.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({}) {
      class FlatFileSystem {
        static {
          __name(this, "FlatFileSystem");
        }
        constructor({}) {
        }
...
// target/test/main.wsim/.wing/handler_c8b42866.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    const $Closure2Client = require_inflight_Closure2_6()({
      $expect_Util: require_expect().Util,
      $fs: await (async () => {
        const FlatFileSystemClient = require_inflight_FlatFileSystem_6()({});
        const client2 = new FlatFileSystemClient({});
