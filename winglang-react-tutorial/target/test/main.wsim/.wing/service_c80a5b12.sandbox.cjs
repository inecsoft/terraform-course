      ...
      exports.start = async function() {
        ...
        const client = await 
          ...
          require("/home/iarteaga/terraform-course/winglang-react-tutorial/target/test/main.wsim/.wing/inflight.$Closure1-3.cjs")({
            ...
            $__parent_this_1_env: {"title": "Learn React with Wing power by TFGM","apiUrl": process.env["WING_TOKEN_WSIM_ROOT_ENV1_API_ATTRS_URL"],},
            ...
            $state: (function() {
  let handle = process.env.STATE_HANDLE_3b74e5eb;
  if (!handle) {
    throw new Error("Missing environment variable: STATE_HANDLE_3b74e5eb");
  }
