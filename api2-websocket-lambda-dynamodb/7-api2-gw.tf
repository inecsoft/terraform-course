...
#-------------------------------------------------------------------
resource "aws_apigatewayv2_api_mapping" "apigatewayv2-api-mapping" {
  api_id      = aws_apigatewayv2_api.apigatewayv2-api.id
  domain_name = aws_apigatewayv2_domain_name.apigatewayv2-domain-name.id
  stage       = aws_apigatewayv2_stage.apigatewayv2-stage-prod.id
}
#-------------------------------------------------------------------
resource "aws_apigatewayv2_deployment" "apigatewayv2-deployment-get" {
  api_id      = aws_apigatewayv2_route.apigatewayv2-route-get.api_id
  description = "apigatewayv2 deployment get test"
...
# #-------------------------------------------------------------------
# resource "aws_apigatewayv2_deployment" "apigatewayv2-deployment-disconnect" {
...
output "api-endpoint-stage-test-invoke-url" {
  description = "The URI of the API"
  value       = aws_apigatewayv2_stage.apigatewayv2-stage-test.invoke_url
}
#-------------------------------------------------------------------