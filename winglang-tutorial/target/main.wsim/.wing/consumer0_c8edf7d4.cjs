...
exports.handler = async function(event) {
  ...
  handler: 
          ...
          require("/home/iarteaga/terraform-course/winglang-tutorial/target/main.wsim/.wing/inflight.$Closure1-1.cjs")({
            $b: (function() {
  let handle = process.env.BUCKET_HANDLE_fcb75501;
  if (!handle) {
    throw new Error("Missing environment variable: BUCKET_HANDLE_fcb75501");
  }
