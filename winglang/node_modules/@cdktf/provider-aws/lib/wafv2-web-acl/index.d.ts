...
export declare function wafv2WebAclAssociationConfigRequestBodyCloudfrontToTerraform(struct?: Wafv2WebAclAssociationConfigRequestBodyCloudfront | cdktf.IResolvable): any;
export declare function wafv2WebAclAssociationConfigRequestBodyCloudfrontToHclTerraform(struct?: Wafv2WebAclAssociationConfigRequestBodyCloudfront | cdktf.IResolvable): any;
export declare class Wafv2WebAclAssociationConfigRequestBodyCloudfrontOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): Wafv2WebAclAssociationConfigRequestBodyCloudfront | cdktf.IResolvable | undefined;
    set internalValue(value: Wafv2WebAclAssociationConfigRequestBodyCloudfront | cdktf.IResolvable | undefined);
...
export declare class Wafv2WebAclAssociationConfigRequestBodyCloudfrontList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: Wafv2WebAclAssociationConfigRequestBodyCloudfront[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    get(index: number): Wafv2WebAclAssociationConfigRequestBodyCloudfrontOutputReference;
}
...
export declare class Wafv2WebAclAssociationConfigRequestBodyOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    private _cloudfront;
    get cloudfront(): Wafv2WebAclAssociationConfigRequestBodyCloudfrontList;
    putCloudfront(value: Wafv2WebAclAssociationConfigRequestBodyCloudfront[] | cdktf.IResolvable): void;
    resetCloudfront(): void;
    get cloudfrontInput(): cdktf.IResolvable | Wafv2WebAclAssociationConfigRequestBodyCloudfront[] | undefined;
}
...
export declare class Wafv2WebAcl extends cdktf.TerraformResource {
    ...
    * @param importFromId The id of the existing Wafv2WebAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.46.0/docs/resources/wafv2_web_acl#import import section} in the documentation of this resource for the id to use
