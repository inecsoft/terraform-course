...
export declare function lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValueToTerraform(struct?: Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValue | cdktf.IResolvable): any;
export declare function lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValueToHclTerraform(struct?: Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValue | cdktf.IResolvable): any;
export declare class Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValueOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    private resolvableValue?;
    /**
    * @param terraformResource The parent resource
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValue | cdktf.IResolvable | undefined;
    set internalValue(value: Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValue | cdktf.IResolvable | undefined);
    private _value?;
    get value(): string;
    set value(value: string);
    get valueInput(): string | undefined;
}
export declare class Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValueList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValue[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    * @param wrapsSet whether the list is wrapping a set (will add tolist() to be able to access an item via an index)
    ...
    * @param index the index of the item to return
    */
    get(index: number): Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValueOutputReference;
}
...
export declare class Lexv2ModelsSlotTypeSlotTypeValuesOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    private _slotTypeValue;
    get slotTypeValue(): Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValueList;
    putSlotTypeValue(value: Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValue[] | cdktf.IResolvable): void;
    resetSlotTypeValue(): void;
    get slotTypeValueInput(): cdktf.IResolvable | Lexv2ModelsSlotTypeSlotTypeValuesSlotTypeValue[] | undefined;
    private _synonyms;
...
export declare class Lexv2ModelsSlotTypeValueSelectionSettingAdvancedRecognitionSettingOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    private _audioRecognitionSetting?;
    get audioRecognitionSetting(): string;
    set audioRecognitionSetting(value: string);
    resetAudioRecognitionSetting(): void;
    get audioRecognitionSettingInput(): string | undefined;
}
...
export declare class Lexv2ModelsSlotType extends cdktf.TerraformResource {
    ...
    * @param importFromId The id of the existing Lexv2ModelsSlotType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.46.0/docs/resources/lexv2models_slot_type#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.46.0/docs/resources/lexv2models_slot_type aws_lexv2models_slot_type} Resource
    *
    * @param scope The scope in which to define this construct
