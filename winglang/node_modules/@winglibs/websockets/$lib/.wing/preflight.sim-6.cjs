...
const api = require("./preflight.api-1.cjs");
class WebSocket_sim extends $stdlib.std.Resource {
  constructor($scope, $id, props) {
    ...
    class $Closure3 extends $stdlib.std.AutoIdResource {
      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.$Closure3-3.cjs")({
          })
        `;
      }
      _toInflight() {
    ...
    class $Closure4 extends $stdlib.std.AutoIdResource {
      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.$Closure4-3.cjs")({
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.WebSocket_sim-3.cjs")({
...
//# sourceMappingURL=preflight.sim-6.cjs.map