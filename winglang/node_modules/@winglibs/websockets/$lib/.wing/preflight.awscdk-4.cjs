...
const commons = require("./preflight.api-1.cjs");
const awsapi = require("./preflight.api-3.cjs");
...
class WebSocket_awscdk extends $stdlib.std.Resource {
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.WebSocket_awscdk-1.cjs")({
      })
    `;
  }
  _toInflight() {
...
//# sourceMappingURL=preflight.awscdk-4.cjs.map