...
const awscdk = require("./preflight.awscdk-4.cjs");
const tfaws = require("./preflight.tfaws-5.cjs");
const sim = require("./preflight.sim-6.cjs");
class WebSocket extends $stdlib.std.Resource {
  ...
  static _toInflightType() {
    return `
      require("${$helpers.normalPath(__dirname)}/inflight.WebSocket-4.cjs")({
      })
    `;
  }
  _toInflight() {
