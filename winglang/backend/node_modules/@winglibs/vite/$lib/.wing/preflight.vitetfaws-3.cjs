...
class Util extends $stdlib.std.Resource {
  ...
  static contentType(filename) {
    return (require("../../util.cjs")["contentType"])(filename)
  }
...
class Vite_tf_aws extends $stdlib.std.Resource {
  constructor($scope, $id, props) {
    ...
    const terraformBucket = bucket.node.defaultChild;
  ...
  static cliFilename() {
    return (require("../../vite.cjs")["cliFilename"])()
  }
  static build(options) {
    return (require("../../vite.cjs")["build"])(options)
  }
  static _toInflightType() {
    return `
