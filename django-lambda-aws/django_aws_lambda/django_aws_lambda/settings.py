...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY",  default='django-insecure-&80-cq*a7p$!xfo0k=3*v^w5v0o(uo1)8=e7i+q644^y(volsf')
...
MIDDLEWARE = [
    ...
    'django_aws_lambda.middleware.HealthCheckMiddleware',
]
