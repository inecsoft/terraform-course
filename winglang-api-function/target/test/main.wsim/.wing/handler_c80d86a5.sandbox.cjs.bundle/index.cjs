...
// target/test/main.wsim/.wing/inflight.$Closure4-1.cjs
var require_inflight_Closure4_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure4-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $apishortener_url, $expect_Util, $http_RequestRedirect, $http_Util, $std_Json }) {
      class $Closure4 {
        static {
        ...
        async handle() {
          ...
          console.log(String.raw({ raw: ["", ""] }, ((json, opts) => {
            return JSON.stringify(json, null, opts?.indent);
          })(resp.headers)));
          await $expect_Util.equal("https://www.winglang.io", ((obj, key) => {
            if (!(key in obj))
...
// ../../.nvm/versions/node/v20.11.0/lib/node_modules/winglang/node_modules/@winglang/sdk/lib/expect/assert.js
var require_assert = __commonJS({
  "../../.nvm/versions/node/v20.11.0/lib/node_modules/winglang/node_modules/@winglang/sdk/lib/expect/assert.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
// target/test/main.wsim/.wing/handler_c80d86a5.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    const $Closure4Client = require_inflight_Closure4_1()({
