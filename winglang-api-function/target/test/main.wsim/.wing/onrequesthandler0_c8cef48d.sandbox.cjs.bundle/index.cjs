...
// target/test/main.wsim/.wing/inflight.Shortener-1.cjs
var require_inflight_Shortener_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.Shortener-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
...
// target/test/main.wsim/.wing/onrequesthandler0_c8cef48d.sandbox.cjs
var $handler = void 0;
        ...
        $s: await (async () => {
          ...
          const client2 = new ShortenerClient({
            $this_mapping: function() {
              let handle = process.env.BUCKET_HANDLE_11613e01;
              if (!handle) {
                throw new Error("Missing environment variable: BUCKET_HANDLE_11613e01");
              }
