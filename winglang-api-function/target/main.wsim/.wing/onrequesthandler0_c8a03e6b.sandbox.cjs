...
exports.handler = async function(event) {
  $handler = $handler ?? (new (require("/home/iarteaga/.nvm/versions/node/v20.11.0/lib/node_modules/winglang/node_modules/@winglang/sdk/lib/target-sim/api.onrequest.inflight.js")).ApiOnRequestHandlerClient({ handler: 
          ...
          require("/home/iarteaga/terraform-course/winglang-api-function/target/main.wsim/.wing/inflight.$Closure1-1.cjs")({
            $s: 
          (await (async () => {
            const ShortenerClient = 
          require("/home/iarteaga/terraform-course/winglang-api-function/target/main.wsim/.wing/inflight.Shortener-1.cjs")({
          })
        ;
