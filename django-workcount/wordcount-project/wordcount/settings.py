...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", default='django-insecure-p9d7g*gb$pgeso4)!p%#)0^588)%cdrcsr4dd#zq$57s2^y28f')
...
MIDDLEWARE = [
    ...
    'wordcount.middleware.HealthCheckMiddleware',
]
